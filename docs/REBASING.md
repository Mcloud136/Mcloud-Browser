# Rebasing Mcloud Browser

My primary job as the founder and main dev of Mcloud Browser is rebasing Mcloud Browser to match newer upstream Chromium versions.
...
We have a [bookmarks file](https://github.com/Alex313031/mcloud/blob/main/infra/MCLOUD_DEV_BOOKMARKS.html) located in __//infra__ 
which has a (not super well organized) bookmark list of all the files mcloud uses.

The bookmarks file can be imported at chrome://bookmarks. Each file will be at the current Mcloud Browser revision, and it will also show 
