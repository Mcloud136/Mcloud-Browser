...
displayHelp () {
	printf "\n" &&
	printf "${bold}${YEL}Script to build Mcloud Browser DEBUG on Linux.${c0}\n" &&
...
printf "\n" &&
printf "${YEL}Building Mcloud Browser DEBUG for Linux...\n" &&
printf "${CYA}\n" &&
...
cd ${CR_SRC_DIR} &&
autoninja -C /out/mcloud chrome chrome_sandbox chromedriver mcloud_shell mcloud_ui_debug_shell clear_key_cdm -j$@ &&
cd ~/mcloud/infra/DEBUG &&

mkdir -v -p ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell &&
mkdir -v -p ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/lib &&
...
cp -r -f -v ./icons/icon_256.png ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
...
cp -r -f -v Mcloud Browser_Debug_Shell.sh ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell &&
...
# cp -r -f -v ~/chromium/src/out/mcloud/libffmpeg.so ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
cp -r -f -v ~/chromium/src/out/mcloud/libffmpeg.so ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/lib &&
# cp -r -f -v ~/chromium/src/out/mcloud/libblink_test_plugin.so ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
...
cp -r -f -v ~/chromium/src/out/mcloud/libEGL.so ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
cp -r -f -v ~/chromium/src/out/mcloud/libGLESv2.so ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
cp -r -f -v ~/chromium/src/out/mcloud/libvk_swiftshader.so ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
cp -r -f -v ~/chromium/src/out/mcloud/libvulkan.so.1 ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
...
cp -r -f -v ~/chromium/src/out/mcloud/mcloud_ui_debug_shell ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
cp -r -f -v ClearKeyCdm ~/chromium/src/out/mcloud/Mcloud Browser_UI_Debug_Shell/ &&
