...
- [args.list（Linux）](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/args.list)
- [win_args.list（Windows）](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/win_args.list)
- [gn_args.list（Linux）](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/gn_args.list)
- [win_gn_args.list（Windows）](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/win_gn_args.list)
- [mac_args.list（macOS）](https://github.com/Mcloud136/Mcloud-Browser/blob/main/other/Mac/mac_args.list)
- [BUILD.gn（content，Linux 依赖）](https://github.com/Mcloud136/Mcloud-Browser/blob/main/src/content/browser/BUILD.gn)
...
- [args.list（Linux）:5190-5196](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/args.list#L5190-L5196)
- [gn_args.list（Linux）:5963-5990](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/gn_args.list#L5963-L5990)
...
- [M151-opt-benchmark.md:19-25](https://github.com/Mcloud136/Mcloud-Browser/blob/main/docs/dev-logs/M151-opt-benchmark.md#L19-L25)
...
- [args.list（Linux）:5190-5196](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/args.list#L5190-L5196)
- [gn_args.list（Linux）:5963-5990](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/gn_args.list#L5963-L5990)
- [win_args.list（Windows）:5415-5431](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/win_args.list#L5415-L5431)
- [win_gn_args.list（Windows）:5570-5591](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/win_gn_args.list#L5570-L5591)
- [mac_args.list（macOS）:5057-5063](https://github.com/Mcloud136/Mcloud-Browser/blob/main/other/Mac/mac_args.list#L5057-L5063)
- [memory-Enable-the-tab-discards-feature.patch:1-98](https://github.com/Mcloud136/Mcloud-Browser/blob/main/infra/Flatpak/com.mcloud.browser/patches/chromium/memory-Enable-the-tab-discards-feature.patch#L1-L98)
...
图表来源
- [bench_memory.ps1:13-77](https://github.com/Mcloud136/Mcloud-Browser/blob/main/benchmark/bench_memory.ps1#L13-L77)
