...
&#45; Add new Mcloud Browser shortcuts to Mcloud Browser OS Shortcuts App
...
Chromium > Mcloud Browser
Chrome > Mcloud Browser
Google Mcloud Browser > Mcloud Browser
Google recommends Mcloud Browser > Alex313031 recommends Mcloud Browser
Mcloud Browser Web Store > Chrome Web Store (Except some UI elements like NTP)
Mcloud Browser Remote Desktop > Chrome Remote Desktop
Mcloud Browser OS Flex > Mcloud Browser OS
made possible by Mcloud Browser > Chromium
Experiments > Mcloud Browser Experiments
...
SSD Restore > https://github.com/Alex313031/mcloud/issues/61
Add textbox disk cache dir flag > https://github.com/Alex313031/mcloud/issues/860
...
Test non-optimized Mcloud Browser, versus optimized Mcloud Browser, versus vanilla Chromium, versus vanilla Google Chrome, all at the same revision.
...
Add restart mcloud, report issue, and whats new menu items from Primo and new function
...
Move mcloud_shell, portable, and appimage to other, update doc refs
...
Add mcloud custom keyboard accelerators to chrome/browser/ui/cocoa/accelerators_cocoa.mm

add mcloud 2024 if else:
...
Add PRIMO_DEBUG fixes to Mcloud Browser.
