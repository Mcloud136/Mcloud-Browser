...
- [docs/architecture/build-pipeline-flow.evidence.md](file://docs/architecture/build-pipeline-flow.evidence.md)
</cite>
...
- [docs/architecture/build-pipeline-flow.dot:1-24](file://docs/architecture/build-pipeline-flow.dot#L1-L24)
...
- [win_scripts/deploy_mcloud.py:1-51](file://win_scripts/deploy_mcloud.py#L1-L51)
- [win_scripts/build_win.py:1-51](file://win_scripts/build_win.py#L1-L51)
- [docs/architecture/build-pipeline-flow.evidence.md:28-55](file://docs/architecture/build-pipeline-flow.evidence.md#L28-L55)
